...
const getCurrentUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield UserConnection_1.User.findById(req.user._id);
        if (!user)
...
const deleteUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const deletedUser = yield UserConnection_1.User.findByIdAndDelete(req.user._id);
        if (!deletedUser)
            return res.status(404).json({ message: "User not found" });
        ...
        const deletedOrganizations = (yield MainConnection_1.Organization.deleteMany({ _id: { $in: organizationIds } })).deletedCount;
