...
export default function MainNav() {
  const { organization, logOut } = useAppContext()
  ...
  const nav = (
    organization?._id
      ? <nav className="h-[100%] p-5 flex flex-col justify-center gap-2">
        <Button color='info' variant='contained' fullWidth component={Link} to={"/" + organization._id}><p>Ohjauspaneeli</p></Button>
        <Button color='info' variant='contained' fullWidth component={Link} to={"/" + organization._id + "/events"}><p>Tapahtumat</p></Button>
        <Button color='info' variant='contained' fullWidth component={Link} to={"/" + organization._id + "/organization"}><p>Seurakunta</p></Button>
        <Button color='info' variant='contained' fullWidth component={Link} to={"/" + organization._id + "/analytics"}><p>Analytiikka</p></Button>
        <Button color='info' variant='contained' fullWidth component={Link} to={"/" + organization._id + "/subscription"}><p>Tiimi & Tilaus</p></Button>
        <br />
        <Button color='info' variant='outlined' fullWidth component={Link} to="/"><p>Vaihda seurakuntaasi</p></Button>
        <Button color='info' variant='text' component={Link} to="/" onClick={() => { logOut() }}><p>Kirjaudu ulos</p></Button>
      </nav>
      : <nav className="h-[100%] p-5 flex flex-col justify-center gap-2">
